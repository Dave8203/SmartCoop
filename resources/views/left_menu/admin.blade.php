        ...
        <div class="sidebar-user-material">
            <div class="category-content">
                <div class="sidebar-user-material-content">
                    ...
                    <p class="text-white"><i class="fas icon-user"></i> {{trans_choice('general.welcome',1)}}
                        {{ Sentinel::getUser()->first_name }} {{ Sentinel::getUser()->last_name }}</p>
...
{{--                    @endif--}}
                    ...
                    <li class="treeview @if(Request::is('branch/*')) active @endif">
                        <a href="#">
                            <i class="fa fa-briefcase"></i> <span>{{trans_choice('general.branphpch',2)}}</span>
                        </a>
                    ...
                    <li class="treeview @if(Request::is('borrower/*')) active @endif">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="{{ url('borrower/data') }}"><i
                                        class="fa fa-circle-o"></i>{{trans_choice('general.active_client', 2)}}
                                    <!-- {{trans_choice('general.view',1)}} {{trans_choice('general.borrower',2)}}
                                        --></a></li>
                            {{--<li>
                                <a href="{{ url('borrower/pending') }}"><i
                                        class="fa fa-circle-o"></i>{{trans_choice('general.unsubscribe_customer', 2)}}
                                    <!--{{trans_choice('general.borrower',2)}} {{trans_choice('general.pending',1)}}
                                            --><span class="pull-right-container">
                                        <span
                                            class="label label-danger pull-right">{{\App\Models\Borrower::where('branch_id', session('branch_id'))->where('active',0)->count() }}</span>
                                    </span>
                                </a>
                            </li>--}}
                            @endif
                            @if(Sentinel::hasAccess('borrowers.create'))
                            <li><a href="{{ url('borrower/create') }}"><i class="fa fa-circle-o"></i>
                                    {{trans_choice('general.create_new_customer', 2)}}
                                    <!--{{trans_choice('general.add',1)}} {{trans_choice('general.borrower',2)}}
                                        --></a></li>
                            @endif
                            @if(Sentinel::hasAccess('borrowers.groups'))
                            <li><a href="{{ url('borrower/group/data') }}"><i class="fa fa-circle-o"></i>
                                    {{trans_choice('general.view',1)}} {{trans_choice('general.borrower',1)}}
                                    {{trans_choice('general.group',2)}}
                                </a></li>
                            @endif
                            @if(Sentinel::hasAccess('borrowers.groups'))
                            <li><a href="{{ url('borrower/group/create') }}"><i class="fa fa-circle-o"></i>
                ...
                @if(Request::is('loan/data')) active @endif @if(Request::is('loan/create')) active @endif @if(Request::is('loan/loan_calculator/*')) active @endif
                        ...
                        <ul class="treeview-menu">
                            @if(Sentinel::hasAccess('loans.update'))
                                <li><a href="{{ url('loan/loan_application/data') }}"><i
                                                class="fa fa-circle-o"></i>{{trans_choice('general.view',1)}}
                                        <!--- {{trans_choice('general.application',2)}}-->
                                    </a></li>
                            @endif
                            @if(Sentinel::hasAccess('loans.view'))
                            <li><a href="{{ url('loan/data') }}"><i
                                        class="fa fa-circle-o"></i>{{trans_choice('general.loan_report',2)}}
                                    <!---{{trans_choice('general.view',2)}} {{trans_choice('general.all',2)}} {{trans_choice('general.loan',2)}}
                                            ---><span class="pull-right-container">
                                        <span
                                            class="label label-info pull-right">{{\App\Models\Loan::where('branch_id', session('branch_id'))->count() }}</span>
                                    </span>
                                </a></li>
                            @endif
                        ...
                        <ul class="treeview-menu">
                            ...
                            @if(Sentinel::hasAccess('loans.products'))
                                <li><a href="{{ url('loan/loan_product/data') }}"><i
                                        ...
                                        <!--- {{trans_choice('general.manage',1)}} {{trans_choice('general.loan',1)}} {{trans_choice('general.product',2)}}--->
                                    </a></li>
                            @endif
                                ...
                                @if(Sentinel::hasAccess('loans.update'))
                                    <li><a href="{{ url('loan/loan_disbursed_by/data') }}"><i
                                                    class="fa fa-circle-o"></i>{{trans_choice('general.officer_report',1)}}
                                            <!--- {{trans_choice('general.manage',1)}} {{trans_choice('general.disbursed_by',1)}}-->
                                        </a></li>
                                @endif
                            {{--@if(Sentinel::hasAccess('loans.view'))
                                    <li><a href="{{ url('branch/data') }}"><i
                                                    class="fa fa-circle-o"></i>{{trans_choice('general.office_report',1)}}
                                            <!--- {{trans_choice('general.manage',2)}} {{trans_choice('general.disbursed_by',2)}}-->
                                        </a></li>
                                @endif--}}
                        </ul>
                    </li>
                    ...
                    <li class="treeview @if(Request::is('collateral/*')) active @endif">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="{{ url('collateral/data') }}"><i class="fa fa-circle-o"></i>
                                    {{trans_choice('general.warranty_report',1)}}
                                    <!---{{trans_choice('general.view',2)}} {{trans_choice('general.collateral',2)}} {{trans_choice('general.register',2)}}-->
                                </a></li>
                            @endif
                            @if(Sentinel::hasAccess('collateral.view'))
                            <li><a href="{{ url('collateral/data/create') }}"><i class="fa fa-circle-o"></i>
                                    {{trans_choice('general.create_new_warranty',1)}}
                                    <!---{{trans_choice('general.view',2)}} {{trans_choice('general.collateral',2)}} {{trans_choice('general.register',2)}}-->
                                </a></li>
                            @endif
                            @if(Sentinel::hasAccess('collateral.create'))
                            <li><a href="{{ url('collateral/type/data') }}"><i class="fa fa-circle-o"></i>
                                    {{trans_choice('general.types_guarantees',1)}}
                                    <!---{{trans_choice('general.manage',2)}} {{trans_choice('general.collateral',2)}} {{trans_choice('general.type',2)}}--->
                                </a></li>
                            @endif
                        </ul>
                    </li>
                    ...
                    <li class="treeview 
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="{{ url('repayment/data') }}"><i
                                        class="fa fa-circle-o"></i>{{trans_choice('general.payment_report',1)}}
                                    <!---{{trans_choice('general.repayment',2)}}
                                        --></a></li>
                            @endif
                            @if(Sentinel::hasAccess('repayments.create'))
                            <li><a href="{{ url('repayment/create') }}"><i class="fa fa-circle-o"></i>
                                    {{trans_choice('general.create_new_payment',1)}}
                                    <!---{{trans_choice('general.add',2)}} {{trans_choice('general.repayment',1)}}
                                        --></a></li>
                            @endif
                    ...
                    @if(Request::is('accounting/*')) active @endif
                        ...
                        <ul class="treeview-menu">
                            @if(Sentinel::hasAccess('repayments.view'))
                            <li><a href="{{ url('chart_of_account/data') }}"><i class="fa fa-circle-o"></i>
                                    {{trans_choice('general.chart_of_account',2)}}
                                </a></li>
                            @endif
                            @if(Sentinel::hasAccess('repayments.view'))
                            <li><a href="{{ url('accounting/journal') }}"><i class="fa fa-circle-o"></i>
                                    <!---{{trans_choice('general.journal',1)}}--->{{trans_choice('general.general_diary',1)}}
                                </a></li>
                            @endif
                            @if(Sentinel::hasAccess('repayments.view'))
                            <li><a href="{{ url('accounting/ledger') }}"><i class="fa fa-circle-o"></i>
                                    {{trans_choice('general.ledger',1)}}
                                </a></li>
                            @endif
                            @if(Sentinel::hasAccess('repayments.view'))
                            <li><a href="{{ url('accounting/manual_entry/create') }}"><i class="fa fa-circle-o"></i>
                                    <!---{{trans_choice('general.add',1)}} {{trans_choice('general.journal',1)}} {{trans_choice('general.manual_entry',1)}}--->{{trans_choice('general.manual_accounting_entry',1)}}
                                </a></li>
                            @endif
                        </ul>
                    </li>
                    ...
                    <li class="treeview @if(Request::is('report/*')) active @endif">
                        <a href="#">
                            <i class="fa fa-bar-chart"></i> <span>
                                <!--{{trans_choice('general.report',2)}}-->{{trans_choice('general.reports',1)}}</span>
                        </a>
                        <ul class="treeview-menu">
                            <li><a href="{{ url('report/borrower_report') }}"><i
                                        class="fa fa-circle-o"></i>{{trans_choice('general.client_report',1)}}
                                    <!-- {{trans_choice('general.report',2)}} {{trans_choice('general.borrower',1)}} 
                                    --></a></li>
                            <li><a href="{{ url('report/loan_report') }}"><i
                                        class="fa fa-circle-o"></i>{{trans_choice('general.loan_report',1)}}
                                    <!--{{trans_choice('general.report',2)}} {{trans_choice('general.loan',1)}} 
                                    --></a></li>
                            {{--<li><a href="{{ url('report/financial_report') }}"><i
                                        class="fa fa-circle-o"></i>{{trans_choice('general.finaancial_report',1)}}
                                    <!--{{trans_choice('general.report',2)}} {{trans_choice('general.financial',1)}} 
                                    --></a></li>--}}
                            <li><a href="{{ url('report/company_report') }}"><i
                                        class="fa fa-circle-o"></i>{{trans_choice('general.administrative_report',1)}}
                                    <!-- {{trans_choice('general.report',2)}} {{trans_choice('general.organisation',1)}} 
                                    --></a></li>
                        </ul>
                    </li>
                    @endif
                    ...
                    <li class="treeview 
                        ...
                        <a href="{{ url('user/data') }}">
                            <i class="fa fa-users"></i> <span>{{trans_choice('general.access_configuration',1)}}
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="{{ url('user/data') }}">
                                    ...
                                    <span>{{trans_choice('general.user_report',1)}}
                                        <!---{{trans_choice('general.view',2)}} {{trans_choice('general.user',2)}}</span>
                                        ---></a></li>
                            @endif
                            @if(Sentinel::hasAccess('users.roles'))
                            <li><a href="{{ url('user/role/data') }}"><i
                                        class="fa fa-circle-o"></i>{{trans_choice('general.user_roles',1)}}
                                    <!---{{trans_choice('general.manage',2)}} {{trans_choice('general.role',2)}}
                                        ---></a></li>
                            @endif
                            @if(Sentinel::hasAccess('users.create'))
                            <li><a href="{{ url('user/create') }}"><i
                                        class="fa fa-circle-o"></i>{{trans_choice('general.create_new_user',1)}}
                                    <!--- {{trans_choice('general.add',2)}} {{trans_choice('general.user',2)}}
                                        ---></a></li>
                            @endif
                        </ul>
                    </li>
                    ...
                    <li class="@if(Request::is('audit_trail/*')) active @endif">
                        <a href="{{ url('audit_trail/data') }}">
                            <i class="fa fa-area-chart"></i> <span>{{trans_choice('general.audit_tracking',1)}}
                                <!--- {{trans_choice('general.audit_trail',2)}}---></span>
                        </a>
                    </li>
                    @endif
                    ...
                    @if(Sentinel::hasAccess('settings'))
                        <li class="@if(Request::is('setting/*')) active @endif">
                            <a href="{{ url('setting/data') }}">
                                <i class="fa fa-cog"></i> <span>{{trans_choice('general.general_configuration',1)}}
                                    <!---{{trans_choice('general.setting',2)}}---></span>
                            </a>
                        </li>
                    @endif
