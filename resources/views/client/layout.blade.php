...
<div class="navbar navbar-inverse bg-indigo">
    ...
    <div class="navbar-collapse collapse" id="navbar-mobile">
        <ul class="nav navbar-nav">
            <li class="@if(Request::is('client_dashboard')) active @endif">
                <a href="{{url('client_dashboard')}}">{{trans_choice('general.general_info',1)}}
            ...
            @if(\App\Models\Setting::where('setting_key','allow_client_apply')->first()->setting_value==1)
                <li class="dropdown @if(Request::is('client/application/*')) active @endif">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                       aria-expanded="false">{{trans_choice('general.loan_application',1)}}
                        <span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
                        <li>
                            <a href="{{url('client/application/data')}}">{{trans_choice('general.my_request',1)}}</a>
                        </li>
                        <li>
                            <a href="{{url('client/application/create')}}">{{trans_choice('general.new_request',1)}}</a>
                        </li>
                        {{--<li>
                            <a href="{{url('client/application/renewal')}}" style="pointer-events: none" >{{trans_choice('general.loan_renewal',1)}}</a>
                        </li>--}}

{{--                        <li>--}}
{{--                            <a href="{{url('client/application/guide')}}">{{trans_choice('general.guide',1)}}</a>--}}
{{--                        </li>--}}
                    </ul>
                </li>
            @endif

            <li class="@if(Request::is('client_guide')) active @endif">
                <a href="{{url('client_guide')}}">{{trans_choice('general.guide',1)}}
                    <span class="sr-only">(current)</span></a>
            </li>
