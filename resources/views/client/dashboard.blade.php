            ...
            <div class="row">
                <div class="col-sm-3 col-xs-6">
                    <div class="description-block border-right">
                        ...
                        @endif
                        <span class="description-text">{{trans_choice('general.total_balance',1)}}</span>
                    </div>
                    <!-- /.description-block -->
                </div>
                <!-- /.col -->
                <div class="col-sm-3 col-xs-6">
                    <div class="description-block border-right">
                        ...
                        @endif
                        <span class="description-text">{{trans_choice('general.total_paid',1)}}</span>
                    </div>
                    <!-- /.description-block -->
                </div>
                <!-- /.col -->
                <div class="col-sm-3 col-xs-6">
                    <div class="description-block border-right">
                        ...
                        @endif
                        <span class="description-text">{{trans_choice('general.balance_due',1)}}</span>
                ...
                <div class="col-sm-3 col-xs-6">
                    <div class="description-block">
                        ...
                        @endif
                        <span class="description-text">{{trans_choice('general.next_payment',1)}}</span>
                    </div>
                    <!-- /.description-block -->
                </div>
            </div>
        ...
        <div class="col-md-7">
            ...
            <div class="panel panel-white">
                <div class="panel-heading">
                    <h6 class="panel-title">{{trans_choice('general.loan_summary',1)}}</h6>
...
?>
                                ...
                                <td>
                                    ...
                                    @else
                                        ...
                                        @if($key->status=='approved')
                                            <span class="label label-info">{{trans_choice('general.waiting_for_disbursement',1)}}</span>
                                        @endif
                                        ...
                                        @if($key->status=='written_off')
                                            <span class="label label-danger">{{trans_choice('general.led_to_loss',1)}}</span>
                                        @endif
                                ...
                                <td>
                                    <a href="{{ url('client/loan/'.$key->id.'/show') }}"
                                       ...
                                       data-title="{{ trans_choice('general.detail',2) }}">{{trans_choice('general.see',1)}}</i>
                                    </a>
                                    <!-- @if(\App\Models\Setting::where('setting_key','enable_online_payment')->first()->setting_value==1 && \App\Helpers\GeneralHelper::loan_total_balance($key->id)>0)
                                        <a href="{{ url('client/loan/'.$key->id.'/pay') }}"
                                           ...
                                           data-title="{{ trans('general.pay') }}">{{trans_choice('general.pay',1)}}</a>
                                    @endif -->
                                </td>
        ...
        <div class="col-md-5">
            <div class="panel panel-white">
                <div class="panel-heading">
                    <h6 class="panel-title">{{trans_choice('general.payment_received',1)}}</h6>
