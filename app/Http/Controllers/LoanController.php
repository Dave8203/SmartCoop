...
class LoanController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        if (empty($loan_product)) {
            Flash::warning(trans('general.noloanproductestablish'));
        ...
        return view('loan.create',
            compact('borrowers', 'users', 'loan_products', 'loan_disbursed_by', 'loan_product', 'borrower_id', 'charges', 'custom_fields'));
    }
    ...
    public function reschedule(Request $request, $id)
    {
        ...
        if (empty($loan_product)) {
            Flash::warning("There is no set of loan products. You must first establish a loan product");
            return redirect()->back();
        }
    ...
    public function store(Request $request)
    {
        ...
        $loan->save();
        GeneralHelper::audit_trail("New loan added with ID:" . $loan->id);
    ...
    public function approve(Request $request, $id)
    {
        ...
        $loan->save();
        GeneralHelper::audit_trail("Loan approved with ID:" . $loan->id);
        Flash::success(trans('general.successfully_saved'));
    ...
    public function unapprove($id)
    {
        ...
        $loan->status = 'pending';
        $loan->save();
        GeneralHelper::audit_trail("Loan not approved with ID:" . $loan->id);
        Flash::success(trans('general.successfully_saved'));
        return redirect('loan/' . $id . '/show');
    }
    ...
    public function disburse(Request $request, $loan)
    {
        ...
        GeneralHelper::audit_trail("Loan disbursed with ID:" . $loan->id);
        Flash::success(trans('general.successfully_saved'));
    ...
    public function rescheduleStore(Request $request, $id)
    {
        ...
        GeneralHelper::audit_trail("Reprogrammed loan with ID:" . $l->id);
        Flash::success(trans('general.successfully_saved'));
        return redirect('loan/' . $loan->id . '/show');
    }
    ...
    public function undisburse($id)
    {
        ...
        GeneralHelper::audit_trail("Unpaid loan with ID:" . $loan->id);
        Flash::success(trans('general.successfully_saved'));
        return redirect('loan/' . $loan->id . '/show');
    }
    ...
    public function decline(Request $request, $id)
    {
        ...
        $loan->save();
        GeneralHelper::audit_trail("Loan rejected with ID:" . $loan->id);
        Flash::success(trans('general.successfully_saved'));
        return redirect('loan/' . $id . '/show');
    }
    ...
    public function write_off(Request $request, $id)
    {
        ...
        GeneralHelper::audit_trail("Loan written off with ID:" . $loan->id);
        Flash::success(trans('general.successfully_saved'));
        return redirect('loan/' . $id . '/show');
    }
    ...
    public function withdraw(Request $request, $id)
    {
        ...
        $loan->save();
        GeneralHelper::audit_trail("Loan withdrawn with ID:" . $loan->id);
        Flash::success(trans('general.successfully_saved'));
        return redirect('loan/' . $id . '/show');
    }
    ...
    public function unwrite_off($id)
    {
        ...
        $loan->status = 'disbursed';
        $loan->save();
        GeneralHelper::audit_trail("Cancel the loan with id:" . $loan->id);
        Flash::success(trans('general.successfully_saved'));
        return redirect('loan/' . $id . '/show');
    }
    ...
    public function delete($id)
    {
        ...
        GeneralHelper::audit_trail("Loan deleted with ID:" . $id);
    ...
    public function waiveInterest(Request $request, $loan)
    {
        ...
        GeneralHelper::audit_trail("Interest excluded from loan with ID:" . $loan->id);
...
//loan repayments
    ...
    public function deleteRepayment($loan, $id)
    {
        ...
        GeneralHelper::audit_trail("Reversed payment for loan with ID:" . $loan->id);
        Flash::success("Pago reversado con éxito");
        return redirect('loan/' . $loan->id . '/show');
    }
...
//    print repayment
    ...
    public function updateRepayment(Request $request, $id)
    {
        ...
        GeneralHelper::audit_trail("Updated payment of the loan with ID:" . $loan_transaction->loan_id);
        Flash::success("Pago guardado con éxito");
        return redirect('loan/' . $loan_transaction->loan_id . '/show');
...
//edit loan schedule
    ...
    public function updateSchedule(Request $request, $loan)
    {
        ...
        if ($request->submit == 'submit') {
            ...
            GeneralHelper::audit_trail("Updated payment schedule for loan with ID:" . $loan->id);
    ...
    public function addCharge(Request $request, $loan)
    {
        ...
        if (!empty($schedule)) {
            ...
            $schedule->save();
            GeneralHelper::audit_trail("Increased interests added to loan with ID:" . $loan->id);
            //trigger transactions refresh
    ...
    public function waiveTransaction(Request $request, $id)
    {
        ...
        if (!empty($schedule)) {
            ...
            $schedule->save();
            GeneralHelper::audit_trail("Interest excluded for loan with ID:" . $loan_transaction->loan_id);
            //trigger transactions refresh
            event(new InterestWaived($loan_transaction));
            event(new RepaymentReversed($loan_transaction));
    ...
    public function override(Request $request, $loan)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            $l->save();
            GeneralHelper::audit_trail("Balance canceled for loan with ID:" . $loan->id);
    ...
    public function emailLoanSchedule($loan)
    {
        ...
        if (!empty($borrower->email)) {
            ...
            $mail->send_to = $borrower->first_name . ' ' . $borrower->last_name . '(' . $borrower->unique_number . ')';
            $mail->save();
            Flash::success("That loan statement has been successfully sent");
            return redirect('loan/' . $loan->id . '/show');
        } else {
            Flash::warning("Cliente no tiene correo electrónico establecido");
            return redirect('loan/' . $loan->id . '/show');
...
//loan applications
    ...
    public function declineApplication($id)
    {
        ...
        $application->save();
        GeneralHelper::audit_trail("The loan application has been rejected with ID:" . $id);
    ...
    public function deleteApplication($id)
    {
        ...
        GeneralHelper::audit_trail("The loan request has been deleted from the client with ID:" . $id);
    ...
    public function storeApproveApplication(Request $request, $id)
    {
        ...
        GeneralHelper::audit_trail("The loan request from the client approved with ID:" . $id);
        Flash::success(trans_choice('general.successfully_saved', 1));
        return redirect('loan/loan_application/data');
    }
...
//loan calculator
    ...
    public function add_guarantor(Request $request, $loan)
    {
        ...
        $guarantor->save();
        GeneralHelper::audit_trail("That guarantor added to the loan with ID:" . $loan->id);
        Flash::success(trans('general.successfully_saved'));
        return redirect()->back();
    }
    ...
    public function remove_guarantor(Request $request, $id)
    {
        ...
        GeneralHelper::audit_trail("Guarantor removed for loan with ID:" . $id);
        Flash::success(trans('general.successfully_saved'));
        return redirect()->back();
    }
}
